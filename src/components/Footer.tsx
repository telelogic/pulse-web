        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-heading font-bold">Pulse</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              {t("footer.description")}
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.press")}</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.blog")}</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-lg font-medium mb-4">{t("footer.resources")}</h4>
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.privacyGuide")}</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.documentation")}</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.caseStudies")}</a></li>
